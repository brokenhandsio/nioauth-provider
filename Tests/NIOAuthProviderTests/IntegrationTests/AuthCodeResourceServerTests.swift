...
//        let oauthProvider = NIOAuthProvider.Provider(codeManager: fakeCodeManager, tokenManager: fakeTokenManager, clientRetriever: clientRetriever, authorizeHandler: capturingAuthouriseHandler, userManager: fakeUserManager, validScopes: [scope, scope2])
//        
...
//        let oauthProvider = NIOAuthProvider.Provider(tokenManager: fakeTokenManager, clientRetriever: clientRetriever, authorizeHandler: capturingAuthouriseHandler, userManager: fakeUserManager, validScopes: [scope, scope2], resourceServerRetriever: resourceServerRetriever)
...
//        let config = Config([:])
//        do {
//            try config.addProvider(NIOAuthProvider.Provider.self)
